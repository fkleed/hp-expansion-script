...
eh_combined_heat_demand_avg <- eh_combined_heat_demand_avg %>%
  mutate(
    SpaceHeat_beginn_1918_avg = ifelse(TemperatureKelvin >= 293.15, 0,  SpaceHeat_beginn_1918_avg),
    SpaceHeat_1919_1948_avg = ifelse(TemperatureKelvin >= 293.15, 0,  SpaceHeat_1919_1948_avg),
    SpaceHeat_1949_1978_avg = ifelse(TemperatureKelvin >= 293.15, 0,  SpaceHeat_1949_1978_avg),
    SpaceHeat_1979_1986_avg = ifelse(TemperatureKelvin >= 293.15, 0,  SpaceHeat_1979_1986_avg),
    SpaceHeat_1987_1990_avg = ifelse(TemperatureKelvin >= 293.15, 0,  SpaceHeat_1987_1990_avg),
    SpaceHeat_1991_1995_avg = ifelse(TemperatureKelvin >= 293.15, 0,  SpaceHeat_1991_1995_avg),
    SpaceHeat_1996_2000_avg = ifelse(TemperatureKelvin >= 293.15, 0,  SpaceHeat_1996_2000_avg),
    SpaceHeat_2001_2011_avg = ifelse(TemperatureKelvin >= 293.15, 0,  SpaceHeat_2001_2011_avg),
    SpaceHeat_2012_2022_avg = ifelse(TemperatureKelvin >= 293.15, 0,  SpaceHeat_2012_2022_avg),
    SpaceHeat_2023_2030_avg = ifelse(TemperatureKelvin >= 293.15, 0,  SpaceHeat_2023_2030_avg)
  )


eh_combined_heat_demand_cold <- eh_combined_heat_demand_cold %>%
  mutate(
    SpaceHeat_beginn_1918_cold = ifelse(TemperatureKelvin >= 293.15, 0,  SpaceHeat_beginn_1918_cold),
    SpaceHeat_1919_1948_cold = ifelse(TemperatureKelvin >= 293.15, 0,  SpaceHeat_1919_1948_cold),
    SpaceHeat_1949_1978_cold = ifelse(TemperatureKelvin >= 293.15, 0,  SpaceHeat_1949_1978_cold),
    SpaceHeat_1979_1986_cold = ifelse(TemperatureKelvin >= 293.15, 0,  SpaceHeat_1979_1986_cold),
    SpaceHeat_1987_1990_cold = ifelse(TemperatureKelvin >= 293.15, 0,  SpaceHeat_1987_1990_cold),
    SpaceHeat_1991_1995_cold = ifelse(TemperatureKelvin >= 293.15, 0,  SpaceHeat_1991_1995_cold),
    SpaceHeat_1996_2000_cold = ifelse(TemperatureKelvin >= 293.15, 0,  SpaceHeat_1996_2000_cold),
    SpaceHeat_2001_2011_cold = ifelse(TemperatureKelvin >= 293.15, 0,  SpaceHeat_2001_2011_cold),
    SpaceHeat_2012_2022_cold = ifelse(TemperatureKelvin >= 293.15, 0,  SpaceHeat_2012_2022_cold),
    SpaceHeat_2023_2030_cold = ifelse(TemperatureKelvin >= 293.15, 0,  SpaceHeat_2023_2030_cold)
  )

eh_combined_heat_demand_hot <- eh_combined_heat_demand_hot %>%
  mutate(
    SpaceHeat_beginn_1918_hot = ifelse(TemperatureKelvin >= 293.15, 0,  SpaceHeat_beginn_1918_hot),
    SpaceHeat_1919_1948_hot = ifelse(TemperatureKelvin >= 293.15, 0,  SpaceHeat_1919_1948_hot),
    SpaceHeat_1949_1978_hot = ifelse(TemperatureKelvin >= 293.15, 0,  SpaceHeat_1949_1978_hot),
    SpaceHeat_1979_1986_hot = ifelse(TemperatureKelvin >= 293.15, 0,  SpaceHeat_1979_1986_hot),
    SpaceHeat_1987_1990_hot = ifelse(TemperatureKelvin >= 293.15, 0,  SpaceHeat_1987_1990_hot),
    SpaceHeat_1991_1995_hot = ifelse(TemperatureKelvin >= 293.15, 0,  SpaceHeat_1991_1995_hot),
    SpaceHeat_1996_2000_hot = ifelse(TemperatureKelvin >= 293.15, 0,  SpaceHeat_1996_2000_hot),
    SpaceHeat_2001_2011_hot = ifelse(TemperatureKelvin >= 293.15, 0,  SpaceHeat_2001_2011_hot),
    SpaceHeat_2012_2022_hot = ifelse(TemperatureKelvin >= 293.15, 0,  SpaceHeat_2012_2022_hot),
    SpaceHeat_2023_2030_hot = ifelse(TemperatureKelvin >= 293.15, 0,  SpaceHeat_2023_2030_hot)
  )
