...
eh_combined_heat_demand_reference <- eh_combined_heat_demand_reference %>%
  mutate(
    COPHPTheo_beginn_1918_reference = FlowTemp_beginn_1918_reference / (FlowTemp_beginn_1918_reference - SoilTemperatureKelvin),
    COPHPTheo_1919_1948_reference = FlowTemp_1919_1948_reference / (FlowTemp_1919_1948_reference - SoilTemperatureKelvin),
    COPHPTheo_1949_1978_reference = FlowTemp_1949_1978_reference / (FlowTemp_1949_1978_reference - SoilTemperatureKelvin),
    COPHPTheo_1979_1986_reference = FlowTemp_1979_1986_reference / (FlowTemp_1979_1986_reference - SoilTemperatureKelvin),
    COPHPTheo_1987_1990_reference = FlowTemp_1987_1990_reference / (FlowTemp_1987_1990_reference - SoilTemperatureKelvin),
    COPHPTheo_1991_1995_reference = FlowTemp_1991_1995_reference / (FlowTemp_1991_1995_reference - SoilTemperatureKelvin),
    COPHPTheo_1996_2000_reference = FlowTemp_1996_2000_reference / (FlowTemp_1996_2000_reference - SoilTemperatureKelvin),
    COPHPTheo_2001_2011_reference = FlowTemp_2001_2011_reference / (FlowTemp_2001_2011_reference - SoilTemperatureKelvin),
    COPHPTheo_2012_2022_reference = FlowTemp_2012_2022_reference / (FlowTemp_2012_2022_reference - SoilTemperatureKelvin),
    COPHPTheo_2023_2030_reference = FlowTemp_2023_2030_reference / (FlowTemp_2023_2030_reference - SoilTemperatureKelvin)
  )

eh_combined_heat_demand_cold <- eh_combined_heat_demand_cold %>%
  mutate(
    COPHPTheo_beginn_1918_cold = FlowTemp_beginn_1918_cold / (FlowTemp_beginn_1918_cold - SoilTemperatureKelvin),
    COPHPTheo_1919_1948_cold = FlowTemp_1919_1948_cold / (FlowTemp_1919_1948_cold - SoilTemperatureKelvin),
    COPHPTheo_1949_1978_cold = FlowTemp_1949_1978_cold / (FlowTemp_1949_1978_cold - SoilTemperatureKelvin),
    COPHPTheo_1979_1986_cold = FlowTemp_1979_1986_cold / (FlowTemp_1979_1986_cold - SoilTemperatureKelvin),
    COPHPTheo_1987_1990_cold = FlowTemp_1987_1990_cold / (FlowTemp_1987_1990_cold - SoilTemperatureKelvin),
    COPHPTheo_1991_1995_cold = FlowTemp_1991_1995_cold / (FlowTemp_1991_1995_cold - SoilTemperatureKelvin),
    COPHPTheo_1996_2000_cold = FlowTemp_1996_2000_cold / (FlowTemp_1996_2000_cold - SoilTemperatureKelvin),
    COPHPTheo_2001_2011_cold = FlowTemp_2001_2011_cold / (FlowTemp_2001_2011_cold - SoilTemperatureKelvin),
    COPHPTheo_2012_2022_cold = FlowTemp_2012_2022_cold / (FlowTemp_2012_2022_cold - SoilTemperatureKelvin),
    COPHPTheo_2023_2030_cold = FlowTemp_2023_2030_cold / (FlowTemp_2023_2030_cold - SoilTemperatureKelvin)
  )

eh_combined_heat_demand_hot <- eh_combined_heat_demand_hot %>%
  mutate(
    COPHPTheo_beginn_1918_hot = FlowTemp_beginn_1918_hot / (FlowTemp_beginn_1918_hot - SoilTemperatureKelvin),
    COPHPTheo_1919_1948_hot = FlowTemp_1919_1948_hot / (FlowTemp_1919_1948_hot - SoilTemperatureKelvin),
    COPHPTheo_1949_1978_hot = FlowTemp_1949_1978_hot / (FlowTemp_1949_1978_hot - SoilTemperatureKelvin),
    COPHPTheo_1979_1986_hot = FlowTemp_1979_1986_hot / (FlowTemp_1979_1986_hot - SoilTemperatureKelvin),
    COPHPTheo_1987_1990_hot = FlowTemp_1987_1990_hot / (FlowTemp_1987_1990_hot - SoilTemperatureKelvin),
    COPHPTheo_1991_1995_hot = FlowTemp_1991_1995_hot / (FlowTemp_1991_1995_hot - SoilTemperatureKelvin),
    COPHPTheo_1996_2000_hot = FlowTemp_1996_2000_hot / (FlowTemp_1996_2000_hot - SoilTemperatureKelvin),
    COPHPTheo_2001_2011_hot = FlowTemp_2001_2011_hot / (FlowTemp_2001_2011_hot - SoilTemperatureKelvin),
    COPHPTheo_2012_2022_hot = FlowTemp_2012_2022_hot / (FlowTemp_2012_2022_hot - SoilTemperatureKelvin),
    COPHPTheo_2023_2030_hot = FlowTemp_2023_2030_hot / (FlowTemp_2023_2030_hot - SoilTemperatureKelvin)
  )
...
# Write output to csv
write_csv2(eh_combined_heat_demand_reference, "data/output/loadprofile/eh_loadprofile_gshp_collector_reference.csv")
...
write_csv2(mh_combined_heat_demand_reference, "data/output/loadprofile/mh_loadprofile_gshp_collector_reference.csv")
