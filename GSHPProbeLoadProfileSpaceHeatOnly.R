...
eh_combined_heat_demand_avg <- eh_combined_heat_demand_avg %>%
  mutate(
    COPHPTheo_beginn_1918_avg = FlowTemp_SpaceHeat_beginn_1918_avg / (FlowTemp_SpaceHeat_beginn_1918_avg - soil_temperature),
    COPHPTheo_1919_1948_avg = FlowTemp_SpaceHeat_1919_1948_avg / (FlowTemp_SpaceHeat_1919_1948_avg - soil_temperature),
    COPHPTheo_1949_1978_avg = FlowTemp_SpaceHeat_1949_1978_avg / (FlowTemp_SpaceHeat_1949_1978_avg - soil_temperature),
    COPHPTheo_1979_1986_avg = FlowTemp_SpaceHeat_1979_1986_avg / (FlowTemp_SpaceHeat_1979_1986_avg - soil_temperature),
    COPHPTheo_1987_1990_avg = FlowTemp_SpaceHeat_1987_1990_avg / (FlowTemp_SpaceHeat_1987_1990_avg - soil_temperature),
    COPHPTheo_1991_1995_avg = FlowTemp_SpaceHeat_1991_1995_avg / (FlowTemp_SpaceHeat_1991_1995_avg - soil_temperature),
    COPHPTheo_1996_2000_avg = FlowTemp_SpaceHeat_1996_2000_avg / (FlowTemp_SpaceHeat_1996_2000_avg - soil_temperature),
    COPHPTheo_2001_2011_avg = FlowTemp_SpaceHeat_2001_2011_avg / (FlowTemp_SpaceHeat_2001_2011_avg - soil_temperature),
    COPHPTheo_2012_2022_avg = FlowTemp_SpaceHeat_2012_2022_avg / (FlowTemp_SpaceHeat_2012_2022_avg - soil_temperature),
    COPHPTheo_2023_2030_avg = FlowTemp_SpaceHeat_2023_2030_avg / (FlowTemp_SpaceHeat_2023_2030_avg - soil_temperature)
  )
...
# Write output to csv
write_csv2(eh_combined_heat_demand_avg, "data/output/loadprofile/eh_loadprofile_gshp_probe_space_heat_only_avg.csv")
...
write_csv2(mh_combined_heat_demand_avg, "data/output/loadprofile/mh_loadprofile_gshp_probe_space_heat_only_avg.csv")
