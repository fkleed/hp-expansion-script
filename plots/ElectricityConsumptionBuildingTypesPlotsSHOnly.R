...
loadprofile_reference <-
  read_csv("data/output/electricityconsumptionbuildingtypes/loadprofile_space_heat_only_reference.csv")

loadprofile_cold <-
  read_csv("data/output/electricityconsumptionbuildingtypes/loadprofile_space_heat_only_cold.csv")

loadprofile_hot <-
  read_csv("data/output/electricityconsumptionbuildingtypes/loadprofile_space_heat_only_hot.csv")
