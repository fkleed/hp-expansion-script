...
# Calculate the 10 NUTS 3 regions with the highest max hourly heat pump electricity demand for space heating and hot water
...
# Calculate the 10 NUTS 3 regions with the highest max hourly heat pump electricity demand for space heating only
