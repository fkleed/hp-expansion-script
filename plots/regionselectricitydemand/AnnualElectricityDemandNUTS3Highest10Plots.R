...
highest_regions_annual_electricity_demand_sh_and_hw_plot <-
  ggplot(
...
highest_regions_annual_electricity_demand_sh_only_plot <-
  ggplot(
...
# Save the plots
ggsave(
  "plots/output/regionselectricitydemand/annualelectricitydemandnuts3highest10/highest_regions_annual_electricity_demand_sh_and_hw_plot.png",
  highest_regions_annual_electricity_demand_sh_and_hw_plot,
  width = 30,
  units = "cm"
)
...
ggsave(
  "plots/output/regionselectricitydemand/annualelectricitydemandnuts3highest10/highest_regions_annual_electricity_demand_sh_only_plot.png",
  highest_regions_annual_electricity_demand_sh_only_plot,
  width = 30,
  units = "cm"
)
