...
# Calculate the 5 NUTS 3 regions with the lowest and the 5 NUTS 3 regions with the highest annual heat pump electricity demand for space heating and hot water
...
# Calculate the 5 NUTS 3 regions with the lowest and the 5 NUTS 3 regions with the highest annual heat pump electricity demand for space heating only
