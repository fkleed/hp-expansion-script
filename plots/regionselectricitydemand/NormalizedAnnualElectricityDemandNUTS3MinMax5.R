...
highest_regions_electricity_demand_per_hp_sh_and_hw_reference <-
  regions_electricity_demand_reference %>%
  slice_max(`Electricity demand per HP`, n = 4)

lowest_regions_electricity_demand_per_hp_sh_and_hw_reference <-
  regions_electricity_demand_reference %>%
  slice_min(`Electricity demand per HP`, n = 4)
...
# Save the plots
ggsave(
  "plots/output/regionselectricitydemand/normalizedannualelectricitydemandnuts3minmax5/highest_lowest_regions_annual_electricity_demand_per_hp_sh_and_hw_plot.png",
  highest_lowest_regions_annual_electricity_demand_per_hp_sh_and_hw_plot,
  width = 30,
  units = "cm"
)
...
ggsave(
  "plots/output/regionselectricitydemand/normalizedannualelectricitydemandnuts3minmax5/highest_lowest_regions_annual_electricity_demand_per_hp_sh_only_plot.png",
  highest_lowest_regions_annual_electricity_demand_per_hp_sh_only_plot,
  width = 30,
  units = "cm"
)
