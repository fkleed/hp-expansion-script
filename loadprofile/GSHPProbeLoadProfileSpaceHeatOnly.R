...
eh_combined_heat_demand_reference <- eh_combined_heat_demand_reference %>%
  mutate(
    COPHPTheo_beginn_1918_reference = FlowTemp_SpaceHeat_beginn_1918_reference / (FlowTemp_SpaceHeat_beginn_1918_reference - soil_temperature),
    COPHPTheo_1919_1948_reference = FlowTemp_SpaceHeat_1919_1948_reference / (FlowTemp_SpaceHeat_1919_1948_reference - soil_temperature),
    COPHPTheo_1949_1978_reference = FlowTemp_SpaceHeat_1949_1978_reference / (FlowTemp_SpaceHeat_1949_1978_reference - soil_temperature),
    COPHPTheo_1979_1986_reference = FlowTemp_SpaceHeat_1979_1986_reference / (FlowTemp_SpaceHeat_1979_1986_reference - soil_temperature),
    COPHPTheo_1987_1990_reference = FlowTemp_SpaceHeat_1987_1990_reference / (FlowTemp_SpaceHeat_1987_1990_reference - soil_temperature),
    COPHPTheo_1991_1995_reference = FlowTemp_SpaceHeat_1991_1995_reference / (FlowTemp_SpaceHeat_1991_1995_reference - soil_temperature),
    COPHPTheo_1996_2000_reference = FlowTemp_SpaceHeat_1996_2000_reference / (FlowTemp_SpaceHeat_1996_2000_reference - soil_temperature),
    COPHPTheo_2001_2011_reference = FlowTemp_SpaceHeat_2001_2011_reference / (FlowTemp_SpaceHeat_2001_2011_reference - soil_temperature),
    COPHPTheo_2012_2022_reference = FlowTemp_SpaceHeat_2012_2022_reference / (FlowTemp_SpaceHeat_2012_2022_reference - soil_temperature),
    COPHPTheo_2023_2030_reference = FlowTemp_SpaceHeat_2023_2030_reference / (FlowTemp_SpaceHeat_2023_2030_reference - soil_temperature)
  )

eh_combined_heat_demand_cold <- eh_combined_heat_demand_cold %>%
  mutate(
    COPHPTheo_beginn_1918_cold = FlowTemp_SpaceHeat_beginn_1918_cold / (FlowTemp_SpaceHeat_beginn_1918_cold - soil_temperature),
    COPHPTheo_1919_1948_cold = FlowTemp_SpaceHeat_1919_1948_cold / (FlowTemp_SpaceHeat_1919_1948_cold - soil_temperature),
    COPHPTheo_1949_1978_cold = FlowTemp_SpaceHeat_1949_1978_cold / (FlowTemp_SpaceHeat_1949_1978_cold - soil_temperature),
    COPHPTheo_1979_1986_cold = FlowTemp_SpaceHeat_1979_1986_cold / (FlowTemp_SpaceHeat_1979_1986_cold - soil_temperature),
    COPHPTheo_1987_1990_cold = FlowTemp_SpaceHeat_1987_1990_cold / (FlowTemp_SpaceHeat_1987_1990_cold - soil_temperature),
    COPHPTheo_1991_1995_cold = FlowTemp_SpaceHeat_1991_1995_cold / (FlowTemp_SpaceHeat_1991_1995_cold - soil_temperature),
    COPHPTheo_1996_2000_cold = FlowTemp_SpaceHeat_1996_2000_cold / (FlowTemp_SpaceHeat_1996_2000_cold - soil_temperature),
    COPHPTheo_2001_2011_cold = FlowTemp_SpaceHeat_2001_2011_cold / (FlowTemp_SpaceHeat_2001_2011_cold - soil_temperature),
    COPHPTheo_2012_2022_cold = FlowTemp_SpaceHeat_2012_2022_cold / (FlowTemp_SpaceHeat_2012_2022_cold - soil_temperature),
    COPHPTheo_2023_2030_cold = FlowTemp_SpaceHeat_2023_2030_cold / (FlowTemp_SpaceHeat_2023_2030_cold - soil_temperature)
  )

eh_combined_heat_demand_hot <- eh_combined_heat_demand_hot %>%
  mutate(
    COPHPTheo_beginn_1918_hot = FlowTemp_SpaceHeat_beginn_1918_hot / (FlowTemp_SpaceHeat_beginn_1918_hot - soil_temperature),
    COPHPTheo_1919_1948_hot = FlowTemp_SpaceHeat_1919_1948_hot / (FlowTemp_SpaceHeat_1919_1948_hot - soil_temperature),
    COPHPTheo_1949_1978_hot = FlowTemp_SpaceHeat_1949_1978_hot / (FlowTemp_SpaceHeat_1949_1978_hot - soil_temperature),
    COPHPTheo_1979_1986_hot = FlowTemp_SpaceHeat_1979_1986_hot / (FlowTemp_SpaceHeat_1979_1986_hot - soil_temperature),
    COPHPTheo_1987_1990_hot = FlowTemp_SpaceHeat_1987_1990_hot / (FlowTemp_SpaceHeat_1987_1990_hot - soil_temperature),
    COPHPTheo_1991_1995_hot = FlowTemp_SpaceHeat_1991_1995_hot / (FlowTemp_SpaceHeat_1991_1995_hot - soil_temperature),
    COPHPTheo_1996_2000_hot = FlowTemp_SpaceHeat_1996_2000_hot / (FlowTemp_SpaceHeat_1996_2000_hot - soil_temperature),
    COPHPTheo_2001_2011_hot = FlowTemp_SpaceHeat_2001_2011_hot / (FlowTemp_SpaceHeat_2001_2011_hot - soil_temperature),
    COPHPTheo_2012_2022_hot = FlowTemp_SpaceHeat_2012_2022_hot / (FlowTemp_SpaceHeat_2012_2022_hot - soil_temperature),
    COPHPTheo_2023_2030_hot = FlowTemp_SpaceHeat_2023_2030_hot / (FlowTemp_SpaceHeat_2023_2030_hot - soil_temperature)
  )
...
# Write output to csv
write_csv2(eh_combined_heat_demand_reference, "data/output/loadprofile/eh_loadprofile_gshp_probe_space_heat_only_reference.csv")
write_csv2(eh_combined_heat_demand_cold, "data/output/loadprofile/eh_loadprofile_gshp_probe_space_heat_only_cold.csv")
write_csv2(eh_combined_heat_demand_hot, "data/output/loadprofile/eh_loadprofile_gshp_probe_space_heat_only_hot.csv")


write_csv2(mh_combined_heat_demand_reference, "data/output/loadprofile/mh_loadprofile_gshp_probe_space_heat_only_reference.csv")
write_csv2(mh_combined_heat_demand_cold, "data/output/loadprofile/mh_loadprofile_gshp_probe_space_heat_only_cold.csv")
write_csv2(mh_combined_heat_demand_hot, "data/output/loadprofile/mh_loadprofile_gshp_probe_space_heat_only_hot.csv")
