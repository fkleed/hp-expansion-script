...
eh_combined_heat_demand_reference <- eh_combined_heat_demand_reference %>%
  mutate(
    COPHPTheo_beginn_1918_reference = FlowTemp_SpaceHeat_beginn_1918_reference / (FlowTemp_SpaceHeat_beginn_1918_reference - SoilTemperatureKelvin),
    COPHPTheo_1919_1948_reference = FlowTemp_SpaceHeat_1919_1948_reference / (FlowTemp_SpaceHeat_1919_1948_reference - SoilTemperatureKelvin),
    COPHPTheo_1949_1978_reference = FlowTemp_SpaceHeat_1949_1978_reference / (FlowTemp_SpaceHeat_1949_1978_reference - SoilTemperatureKelvin),
    COPHPTheo_1979_1986_reference = FlowTemp_SpaceHeat_1979_1986_reference / (FlowTemp_SpaceHeat_1979_1986_reference - SoilTemperatureKelvin),
    COPHPTheo_1987_1990_reference = FlowTemp_SpaceHeat_1987_1990_reference / (FlowTemp_SpaceHeat_1987_1990_reference - SoilTemperatureKelvin),
    COPHPTheo_1991_1995_reference = FlowTemp_SpaceHeat_1991_1995_reference / (FlowTemp_SpaceHeat_1991_1995_reference - SoilTemperatureKelvin),
    COPHPTheo_1996_2000_reference = FlowTemp_SpaceHeat_1996_2000_reference / (FlowTemp_SpaceHeat_1996_2000_reference - SoilTemperatureKelvin),
    COPHPTheo_2001_2011_reference = FlowTemp_SpaceHeat_2001_2011_reference / (FlowTemp_SpaceHeat_2001_2011_reference - SoilTemperatureKelvin),
    COPHPTheo_2012_2022_reference = FlowTemp_SpaceHeat_2012_2022_reference / (FlowTemp_SpaceHeat_2012_2022_reference - SoilTemperatureKelvin),
    COPHPTheo_2023_2030_reference = FlowTemp_SpaceHeat_2023_2030_reference / (FlowTemp_SpaceHeat_2023_2030_reference - SoilTemperatureKelvin)
  )

eh_combined_heat_demand_cold <- eh_combined_heat_demand_cold %>%
  mutate(
    COPHPTheo_beginn_1918_cold = FlowTemp_SpaceHeat_beginn_1918_cold / (FlowTemp_SpaceHeat_beginn_1918_cold - SoilTemperatureKelvin),
    COPHPTheo_1919_1948_cold = FlowTemp_SpaceHeat_1919_1948_cold / (FlowTemp_SpaceHeat_1919_1948_cold - SoilTemperatureKelvin),
    COPHPTheo_1949_1978_cold = FlowTemp_SpaceHeat_1949_1978_cold / (FlowTemp_SpaceHeat_1949_1978_cold - SoilTemperatureKelvin),
    COPHPTheo_1979_1986_cold = FlowTemp_SpaceHeat_1979_1986_cold / (FlowTemp_SpaceHeat_1979_1986_cold - SoilTemperatureKelvin),
    COPHPTheo_1987_1990_cold = FlowTemp_SpaceHeat_1987_1990_cold / (FlowTemp_SpaceHeat_1987_1990_cold - SoilTemperatureKelvin),
    COPHPTheo_1991_1995_cold = FlowTemp_SpaceHeat_1991_1995_cold / (FlowTemp_SpaceHeat_1991_1995_cold - SoilTemperatureKelvin),
    COPHPTheo_1996_2000_cold = FlowTemp_SpaceHeat_1996_2000_cold / (FlowTemp_SpaceHeat_1996_2000_cold - SoilTemperatureKelvin),
    COPHPTheo_2001_2011_cold = FlowTemp_SpaceHeat_2001_2011_cold / (FlowTemp_SpaceHeat_2001_2011_cold - SoilTemperatureKelvin),
    COPHPTheo_2012_2022_cold = FlowTemp_SpaceHeat_2012_2022_cold / (FlowTemp_SpaceHeat_2012_2022_cold - SoilTemperatureKelvin),
    COPHPTheo_2023_2030_cold = FlowTemp_SpaceHeat_2023_2030_cold / (FlowTemp_SpaceHeat_2023_2030_cold - SoilTemperatureKelvin)
  )

eh_combined_heat_demand_hot <- eh_combined_heat_demand_hot %>%
  mutate(
    COPHPTheo_beginn_1918_hot = FlowTemp_SpaceHeat_beginn_1918_hot / (FlowTemp_SpaceHeat_beginn_1918_hot - SoilTemperatureKelvin),
    COPHPTheo_1919_1948_hot = FlowTemp_SpaceHeat_1919_1948_hot / (FlowTemp_SpaceHeat_1919_1948_hot - SoilTemperatureKelvin),
    COPHPTheo_1949_1978_hot = FlowTemp_SpaceHeat_1949_1978_hot / (FlowTemp_SpaceHeat_1949_1978_hot - SoilTemperatureKelvin),
    COPHPTheo_1979_1986_hot = FlowTemp_SpaceHeat_1979_1986_hot / (FlowTemp_SpaceHeat_1979_1986_hot - SoilTemperatureKelvin),
    COPHPTheo_1987_1990_hot = FlowTemp_SpaceHeat_1987_1990_hot / (FlowTemp_SpaceHeat_1987_1990_hot - SoilTemperatureKelvin),
    COPHPTheo_1991_1995_hot = FlowTemp_SpaceHeat_1991_1995_hot / (FlowTemp_SpaceHeat_1991_1995_hot - SoilTemperatureKelvin),
    COPHPTheo_1996_2000_hot = FlowTemp_SpaceHeat_1996_2000_hot / (FlowTemp_SpaceHeat_1996_2000_hot - SoilTemperatureKelvin),
    COPHPTheo_2001_2011_hot = FlowTemp_SpaceHeat_2001_2011_hot / (FlowTemp_SpaceHeat_2001_2011_hot - SoilTemperatureKelvin),
    COPHPTheo_2012_2022_hot = FlowTemp_SpaceHeat_2012_2022_hot / (FlowTemp_SpaceHeat_2012_2022_hot - SoilTemperatureKelvin),
    COPHPTheo_2023_2030_hot = FlowTemp_SpaceHeat_2023_2030_hot / (FlowTemp_SpaceHeat_2023_2030_hot - SoilTemperatureKelvin)
  )
...
eh_combined_heat_demand_reference <- eh_combined_heat_demand_reference %>%
  mutate(
    COPHPReal_beginn_1918_reference = COPHPTheo_beginn_1918_reference * efficiency_heatpump,
    COPHPReal_1919_1948_reference = COPHPTheo_1919_1948_reference * efficiency_heatpump,
    COPHPReal_1949_1978_reference = COPHPTheo_1949_1978_reference * efficiency_heatpump,
    COPHPReal_1979_1986_reference = COPHPTheo_1979_1986_reference * efficiency_heatpump,
    COPHPReal_1987_1990_reference = COPHPTheo_1987_1990_reference * efficiency_heatpump,
    COPHPReal_1991_1995_reference = COPHPTheo_1991_1995_reference * efficiency_heatpump,
    COPHPReal_1996_2000_reference = COPHPTheo_1996_2000_reference * efficiency_heatpump,
    COPHPReal_2001_2011_reference = COPHPTheo_2001_2011_reference * efficiency_heatpump,
    COPHPReal_2012_2022_reference = COPHPTheo_2012_2022_reference * efficiency_heatpump,
    COPHPReal_2023_2030_reference = COPHPTheo_2023_2030_reference * efficiency_heatpump
  ) %>%
  select(
    -c(
...
eh_combined_heat_demand_reference <- eh_combined_heat_demand_reference %>%
  mutate(
    ElectricityDemand_beginn_1918_reference = (SpaceHeat_beginn_1918_reference) /
      COPHPReal_beginn_1918_reference,
    ElectricityDemand_1919_1948_reference = (SpaceHeat_1919_1948_reference) /
      COPHPReal_1919_1948_reference,
    ElectricityDemand_1949_1978_reference = (SpaceHeat_1949_1978_reference) /
      COPHPReal_1949_1978_reference,
    ElectricityDemand_1979_1986_reference = (SpaceHeat_1979_1986_reference) /
      COPHPReal_1979_1986_reference,
    ElectricityDemand_1987_1990_reference = (SpaceHeat_1987_1990_reference) /
      COPHPReal_1987_1990_reference,
    ElectricityDemand_1991_1995_reference = (SpaceHeat_1991_1995_reference) /
      COPHPReal_1991_1995_reference,
    ElectricityDemand_1996_2000_reference = (SpaceHeat_1996_2000_reference) /
      COPHPReal_1996_2000_reference,
    ElectricityDemand_2001_2011_reference = (SpaceHeat_2001_2011_reference) /
      COPHPReal_2001_2011_reference,
    ElectricityDemand_2012_2022_reference = (SpaceHeat_2012_2022_reference) /
      COPHPReal_2012_2022_reference,
    ElectricityDemand_2023_2030_reference = (SpaceHeat_2023_2030_reference) /
      COPHPReal_2023_2030_reference
  )

eh_combined_heat_demand_cold <- eh_combined_heat_demand_cold %>%
  mutate(
    ElectricityDemand_beginn_1918_cold = (SpaceHeat_beginn_1918_cold) /
      COPHPReal_beginn_1918_cold,
    ElectricityDemand_1919_1948_cold = (SpaceHeat_1919_1948_cold) /
      COPHPReal_1919_1948_cold,
    ElectricityDemand_1949_1978_cold = (SpaceHeat_1949_1978_cold) /
      COPHPReal_1949_1978_cold,
    ElectricityDemand_1979_1986_cold = (SpaceHeat_1979_1986_cold) /
      COPHPReal_1979_1986_cold,
    ElectricityDemand_1987_1990_cold = (SpaceHeat_1987_1990_cold) /
      COPHPReal_1987_1990_cold,
    ElectricityDemand_1991_1995_cold = (SpaceHeat_1991_1995_cold) /
      COPHPReal_1991_1995_cold,
    ElectricityDemand_1996_2000_cold = (SpaceHeat_1996_2000_cold) /
      COPHPReal_1996_2000_cold,
    ElectricityDemand_2001_2011_cold = (SpaceHeat_2001_2011_cold) /
      COPHPReal_2001_2011_cold,
    ElectricityDemand_2012_2022_cold = (SpaceHeat_2012_2022_cold) /
      COPHPReal_2012_2022_cold,
    ElectricityDemand_2023_2030_cold = (SpaceHeat_2023_2030_cold) /
      COPHPReal_2023_2030_cold
  )

eh_combined_heat_demand_hot <- eh_combined_heat_demand_hot %>%
  mutate(
    ElectricityDemand_beginn_1918_hot = (SpaceHeat_beginn_1918_hot) /
      COPHPReal_beginn_1918_hot,
    ElectricityDemand_1919_1948_hot = (SpaceHeat_1919_1948_hot) /
      COPHPReal_1919_1948_hot,
    ElectricityDemand_1949_1978_hot = (SpaceHeat_1949_1978_hot) /
      COPHPReal_1949_1978_hot,
    ElectricityDemand_1979_1986_hot = (SpaceHeat_1979_1986_hot) /
      COPHPReal_1979_1986_hot,
    ElectricityDemand_1987_1990_hot = (SpaceHeat_1987_1990_hot) /
      COPHPReal_1987_1990_hot,
    ElectricityDemand_1991_1995_hot = (SpaceHeat_1991_1995_hot) /
      COPHPReal_1991_1995_hot,
    ElectricityDemand_1996_2000_hot = (SpaceHeat_1996_2000_hot) /
      COPHPReal_1996_2000_hot,
    ElectricityDemand_2001_2011_hot = (SpaceHeat_2001_2011_hot) /
      COPHPReal_2001_2011_hot,
    ElectricityDemand_2012_2022_hot = (SpaceHeat_2012_2022_hot) /
      COPHPReal_2012_2022_hot,
    ElectricityDemand_2023_2030_hot = (SpaceHeat_2023_2030_hot) /
...
# Reference year eh
sum(eh_combined_heat_demand_reference$SpaceHeat_beginn_1918_reference) / sum(eh_combined_heat_demand_reference$ElectricityDemand_beginn_1918_reference)
sum(eh_combined_heat_demand_reference$SpaceHeat_1996_2000_reference) / sum(eh_combined_heat_demand_reference$ElectricityDemand_1996_2000_reference)
sum(eh_combined_heat_demand_reference$SpaceHeat_2023_2030_reference) / sum(eh_combined_heat_demand_reference$ElectricityDemand_2023_2030_reference)
sum(eh_combined_heat_demand_reference$SpaceHeat_beginn_1918_reference)
sum(eh_combined_heat_demand_reference$SpaceHeat_1996_2000_reference)
sum(eh_combined_heat_demand_reference$SpaceHeat_2023_2030_reference)
...
# Reference year mh
sum(mh_combined_heat_demand_reference$SpaceHeat_beginn_1918_reference) / sum(mh_combined_heat_demand_reference$ElectricityDemand_beginn_1918_reference)
sum(mh_combined_heat_demand_reference$SpaceHeat_1996_2000_reference) / sum(mh_combined_heat_demand_reference$ElectricityDemand_1996_2000_reference)
sum(mh_combined_heat_demand_reference$SpaceHeat_2023_2030_reference) / sum(mh_combined_heat_demand_reference$ElectricityDemand_2023_2030_reference)
sum(mh_combined_heat_demand_reference$SpaceHeat_beginn_1918_reference)
sum(mh_combined_heat_demand_reference$SpaceHeat_1996_2000_reference)
sum(mh_combined_heat_demand_reference$SpaceHeat_2023_2030_reference)
...
# Write output to csv
write_csv2(eh_combined_heat_demand_reference, "data/output/loadprofile/eh_loadprofile_gshp_collector_space_heat_only_reference.csv")
write_csv2(eh_combined_heat_demand_cold, "data/output/loadprofile/eh_loadprofile_gshp_collector_space_heat_only_cold.csv")
write_csv2(eh_combined_heat_demand_hot, "data/output/loadprofile/eh_loadprofile_gshp_collector_space_heat_only_hot.csv")


write_csv2(mh_combined_heat_demand_reference, "data/output/loadprofile/mh_loadprofile_gshp_collector_space_heat_only_reference.csv")
write_csv2(mh_combined_heat_demand_cold, "data/output/loadprofile/mh_loadprofile_gshp_collector_space_heat_only_cold.csv")
write_csv2(mh_combined_heat_demand_hot, "data/output/loadprofile/mh_loadprofile_gshp_collector_space_heat_only_hot.csv")
