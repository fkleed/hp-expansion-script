...
# Write output to csv
write_csv2(eh_combined_heat_demand_avg, "data/output/loadprofile/eh_loadprofile_gshp_collector_space_heat_only_avg.csv")
...
write_csv2(mh_combined_heat_demand_avg, "data/output/loadprofile/mh_loadprofile_gshp_collector_space_heat_only_avg.csv")
