...
eh_combined_heat_demand_avg <- eh_combined_heat_demand_avg %>%
  ...
  left_join(soil_data_avg, by = "Time")
...
eh_combined_heat_demand_avg <- eh_combined_heat_demand_avg %>%
  mutate(
    COPHPTheo_beginn_1918_avg = FlowTemp_SpaceHeat_beginn_1918_avg / (FlowTemp_SpaceHeat_beginn_1918_avg - SoilTemperatureKelvin),
    COPHPTheo_1919_1948_avg = FlowTemp_SpaceHeat_1919_1948_avg / (FlowTemp_SpaceHeat_1919_1948_avg - SoilTemperatureKelvin),
    COPHPTheo_1949_1978_avg = FlowTemp_SpaceHeat_1949_1978_avg / (FlowTemp_SpaceHeat_1949_1978_avg - SoilTemperatureKelvin),
    COPHPTheo_1979_1986_avg = FlowTemp_SpaceHeat_1979_1986_avg / (FlowTemp_SpaceHeat_1979_1986_avg - SoilTemperatureKelvin),
    COPHPTheo_1987_1990_avg = FlowTemp_SpaceHeat_1987_1990_avg / (FlowTemp_SpaceHeat_1987_1990_avg - SoilTemperatureKelvin),
    COPHPTheo_1991_1995_avg = FlowTemp_SpaceHeat_1991_1995_avg / (FlowTemp_SpaceHeat_1991_1995_avg - SoilTemperatureKelvin),
    COPHPTheo_1996_2000_avg = FlowTemp_SpaceHeat_1996_2000_avg / (FlowTemp_SpaceHeat_1996_2000_avg - SoilTemperatureKelvin),
    COPHPTheo_2001_2011_avg = FlowTemp_SpaceHeat_2001_2011_avg / (FlowTemp_SpaceHeat_2001_2011_avg - SoilTemperatureKelvin),
    COPHPTheo_2012_2022_avg = FlowTemp_SpaceHeat_2012_2022_avg / (FlowTemp_SpaceHeat_2012_2022_avg - SoilTemperatureKelvin),
    COPHPTheo_2023_2030_avg = FlowTemp_SpaceHeat_2023_2030_avg / (FlowTemp_SpaceHeat_2023_2030_avg - SoilTemperatureKelvin)
  )
...
eh_combined_heat_demand_avg <- eh_combined_heat_demand_avg %>%
  mutate(
    ElectricityDemand_beginn_1918_avg = (SpaceHeat_beginn_1918_avg) /
      COPHPReal_beginn_1918_avg,
    ElectricityDemand_1919_1948_avg = (SpaceHeat_1919_1948_avg) /
      COPHPReal_1919_1948_avg,
    ElectricityDemand_1949_1978_avg = (SpaceHeat_1949_1978_avg) /
      COPHPReal_1949_1978_avg,
    ElectricityDemand_1979_1986_avg = (SpaceHeat_1979_1986_avg) /
      COPHPReal_1979_1986_avg,
    ElectricityDemand_1987_1990_avg = (SpaceHeat_1987_1990_avg) /
      COPHPReal_1987_1990_avg,
    ElectricityDemand_1991_1995_avg = (SpaceHeat_1991_1995_avg) /
      COPHPReal_1991_1995_avg,
    ElectricityDemand_1996_2000_avg = (SpaceHeat_1996_2000_avg) /
      COPHPReal_1996_2000_avg,
    ElectricityDemand_2001_2011_avg = (SpaceHeat_2001_2011_avg) /
      COPHPReal_2001_2011_avg,
    ElectricityDemand_2012_2022_avg = (SpaceHeat_2012_2022_avg) /
      COPHPReal_2012_2022_avg,
    ElectricityDemand_2023_2030_avg = (SpaceHeat_2023_2030_avg) /
...
# Write output to csv
# write_csv2(eh_combined_heat_demand_avg, "data/loadprofile/output/eh_loadprofile_gshp_collector_space_heat_only_avg.csv")
# write_csv2(eh_combined_heat_demand_cold, "data/loadprofile/output/eh_loadprofile_gshp_collector_space_heat_only_cold.csv")
# write_csv2(eh_combined_heat_demand_hot, "data/loadprofile/output/eh_loadprofile_gshp_collector_space_heat_only_hot.csv")


# write_csv2(mh_combined_heat_demand_avg, "data/loadprofile/output/mh_loadprofile_gshp_collector_space_heat_only_avg.csv")
# write_csv2(mh_combined_heat_demand_cold, "data/loadprofile/output/mh_loadprofile_gshp_collector_space_heat_only_cold.csv")
# write_csv2(mh_combined_heat_demand_hot, "data/loadprofile/output/mh_loadprofile_gshp_collector_space_heat_only_hot.csv")
