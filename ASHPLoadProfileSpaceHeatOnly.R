...
eh_combined_max_capacity <- eh_combined_heat_demand_reference %>%
  mutate(
    MaxThermalCapacity_beginn_1918 = max(SpaceHeat_beginn_1918_reference),
    MaxThermalCapacity_1919_1948 = max(SpaceHeat_1919_1948_reference),
    MaxThermalCapacity_1949_1978 = max(SpaceHeat_1949_1978_reference),
    MaxThermalCapacity_1979_1986 = max(SpaceHeat_1979_1986_reference),
    MaxThermalCapacity_1987_1990 = max(SpaceHeat_1987_1990_reference),
    MaxThermalCapacity_1991_1995 = max(SpaceHeat_1991_1995_reference),
    MaxThermalCapacity_1996_2000 = max(SpaceHeat_1996_2000_reference),
    MaxThermalCapacity_2001_2011 = max(SpaceHeat_2001_2011_reference),
    MaxThermalCapacity_2012_2022 = max(SpaceHeat_2012_2022_reference),
    MaxThermalCapacity_2023_2030 = max(SpaceHeat_2023_2030_reference)
  ) %>%
  select(
    Time,
...
eh_combined_heat_demand_reference <- eh_combined_heat_demand_reference %>%
  mutate(
    COPHPTheo_beginn_1918_reference = (
      ShareHP_beginn_1918_reference * (FlowTemp_SpaceHeat_beginn_1918_reference  - TemperatureKelvin) + TemperatureKelvin
    ) / (
      ShareHP_beginn_1918_reference * (FlowTemp_SpaceHeat_beginn_1918_reference - TemperatureKelvin)
    ),
    COPHPTheo_1919_1948_reference = (
      ShareHP_1919_1948_reference * (FlowTemp_SpaceHeat_1919_1948_reference  - TemperatureKelvin) + TemperatureKelvin
    ) / (
      ShareHP_1919_1948_reference * (FlowTemp_SpaceHeat_1919_1948_reference - TemperatureKelvin)
    ),
    COPHPTheo_1949_1978_reference = (
      ShareHP_1949_1978_reference * (FlowTemp_SpaceHeat_1949_1978_reference  - TemperatureKelvin) + TemperatureKelvin
    ) / (
      ShareHP_1949_1978_reference * (FlowTemp_SpaceHeat_1949_1978_reference - TemperatureKelvin)
    ),
    COPHPTheo_1979_1986_reference = (
      ShareHP_1979_1986_reference * (FlowTemp_SpaceHeat_1979_1986_reference  - TemperatureKelvin) + TemperatureKelvin
    ) / (
      ShareHP_1979_1986_reference * (FlowTemp_SpaceHeat_1979_1986_reference - TemperatureKelvin)
    ),
    COPHPTheo_1987_1990_reference = (
      ShareHP_1987_1990_reference * (FlowTemp_SpaceHeat_1987_1990_reference  - TemperatureKelvin) + TemperatureKelvin
    ) / (
      ShareHP_1987_1990_reference * (FlowTemp_SpaceHeat_1987_1990_reference - TemperatureKelvin)
    ),
    COPHPTheo_1991_1995_reference = (
      ShareHP_1991_1995_reference * (FlowTemp_SpaceHeat_1991_1995_reference  - TemperatureKelvin) + TemperatureKelvin
    ) / (
      ShareHP_1991_1995_reference * (FlowTemp_SpaceHeat_1991_1995_reference - TemperatureKelvin)
    ),
    COPHPTheo_1996_2000_reference = (
      ShareHP_1996_2000_reference * (FlowTemp_SpaceHeat_1996_2000_reference  - TemperatureKelvin) + TemperatureKelvin
    ) / (
      ShareHP_1996_2000_reference * (FlowTemp_SpaceHeat_1996_2000_reference - TemperatureKelvin)
    ),
    COPHPTheo_2001_2011_reference = (
      ShareHP_2001_2011_reference * (FlowTemp_SpaceHeat_2001_2011_reference  - TemperatureKelvin) + TemperatureKelvin
    ) / (
      ShareHP_2001_2011_reference * (FlowTemp_SpaceHeat_2001_2011_reference - TemperatureKelvin)
    ),
    COPHPTheo_2012_2022_reference = (
      ShareHP_2012_2022_reference * (FlowTemp_SpaceHeat_2012_2022_reference  - TemperatureKelvin) + TemperatureKelvin
    ) / (
      ShareHP_2012_2022_reference * (FlowTemp_SpaceHeat_2012_2022_reference - TemperatureKelvin)
    ),
    COPHPTheo_2023_2030_reference = (
      ShareHP_2023_2030_reference * (FlowTemp_SpaceHeat_2023_2030_reference  - TemperatureKelvin) + TemperatureKelvin
    ) / (
      ShareHP_2023_2030_reference * (FlowTemp_SpaceHeat_2023_2030_reference - TemperatureKelvin)
    )
  )
...
eh_combined_heat_demand_reference <- eh_combined_heat_demand_reference %>%
  mutate(
    ElectricityDemand_beginn_1918_reference = electricity_function((SpaceHeat_beginn_1918_reference),
                                                                   ShareHP_beginn_1918_reference,
                                                                   COPHPReal_beginn_1918_reference
    ),
    ElectricityDemand_1919_1948_reference = electricity_function((SpaceHeat_1919_1948_reference),
                                                                 ShareHP_1919_1948_reference,
                                                                 COPHPReal_1919_1948_reference
    ),
    ElectricityDemand_1949_1978_reference = electricity_function((SpaceHeat_1949_1978_reference),
                                                                 ShareHP_1949_1978_reference,
                                                                 COPHPReal_1949_1978_reference
    ),
    ElectricityDemand_1979_1986_reference = electricity_function((SpaceHeat_1979_1986_reference),
                                                                 ShareHP_1979_1986_reference,
                                                                 COPHPReal_1979_1986_reference
    ),
    ElectricityDemand_1987_1990_reference = electricity_function((SpaceHeat_1987_1990_reference),
                                                                 ShareHP_1987_1990_reference,
                                                                 COPHPReal_1987_1990_reference
    ),
    ElectricityDemand_1991_1995_reference = electricity_function((SpaceHeat_1991_1995_reference),
                                                                 ShareHP_1991_1995_reference,
                                                                 COPHPReal_1991_1995_reference
    ),
    ElectricityDemand_1996_2000_reference = electricity_function((SpaceHeat_1996_2000_reference),
                                                                 ShareHP_1996_2000_reference,
                                                                 COPHPReal_1996_2000_reference
    ),
    ElectricityDemand_2001_2011_reference = electricity_function((SpaceHeat_2001_2011_reference),
                                                                 ShareHP_2001_2011_reference,
                                                                 COPHPReal_2001_2011_reference
    ),
    ElectricityDemand_2012_2022_reference = electricity_function((SpaceHeat_2012_2022_reference),
                                                                 ShareHP_2012_2022_reference,
                                                                 COPHPReal_2012_2022_reference
    ),
    ElectricityDemand_2023_2030_reference = electricity_function((SpaceHeat_2023_2030_reference),
...
# Write output to csv
write_csv2(eh_combined_heat_demand_reference, "data/output/loadprofile/eh_loadprofile_ashp_space_heat_only_reference.csv")
write_csv2(eh_combined_heat_demand_cold, "data/output/loadprofile/eh_loadprofile_ashp_space_heat_only_cold.csv")
write_csv2(eh_combined_heat_demand_hot, "data/output/loadprofile/eh_loadprofile_ashp_space_heat_only_hot.csv")


write_csv2(mh_combined_heat_demand_reference, "data/output/loadprofile/mh_loadprofile_ashp_space_heat_only_reference.csv")
write_csv2(mh_combined_heat_demand_cold, "data/output/loadprofile/mh_loadprofile_ashp_space_heat_only_cold.csv")
write_csv2(mh_combined_heat_demand_hot, "data/output/loadprofile/mh_loadprofile_ashp_space_heat_only_hot.csv")
